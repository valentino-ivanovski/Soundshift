        ...
        dbConn.getUserData(userId, (err, results) => {
            ...
            dbConn.getSubmittedSongs(userId, (err, submittedSongs) => {
                ...
                dbConn.getRetrievedSongs(userId, (err, retrievedSongs) => {
                    ...
                    res.render('adminProfile', { userr: results[0], likedSongs: songs,  submittedSongs: submittedSongs, retrievedSongs: retrievedSongs});
        ...
        dbConn.getLikedSongs(userId, (err, likedSongs) => {
            ...
            dbConn.getSubmittedSongs(userId, (err, submittedSongs) => {
                ...
                dbConn.getRetrievedSongs(userId, (err, retrievedSongs) => {
                    ...
                    res.render('adminOtherProfile', { userr: user, likedSongs: likedSongs, submittedSongs: submittedSongs, retrievedSongs: retrievedSongs });
                });
            });
        });
    });
